...
process.argv.length < 7 &&
    (process.argv.length < 7 && console.log('   '),
        ...
        process.argv.length < 7 &&
        console.log(
            '\x1B[0m\x1B[34m[\x1B[1m\x1B[0m!\x1B[0m\x1B[34m]\x1B[1m\x1B[0m\x1B[1m\x1B[0m Made by \x1B[1m\x1B[31m@medusa'
        ),
        process.argv.length < 7 &&
        console.log(
...
const sig = [
    ...
    medusa = Methods[Math.floor(Math.random() * Methods.length)]
...
const headers = {
    ...
    'sec-ch-ua': '"Not A Brand";v="99", "Google Chrome";v="121", "Chromium";v="121", "Opera GX";v="106"',
